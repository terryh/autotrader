...
executables = [
        ...
        cx_Freeze.Executable("autotrader.py", icon="icons/trade.ico", base = "Win32GUI"),
        cx_Freeze.Executable("quote/DDE.py", icon="icons/dde.ico", base = None),
        cx_Freeze.Executable("quote/quoteworker.py", icon="icons/quoteworker.ico", base = None),
        cx_Freeze.Executable("trader.py", icon="icons/trader.ico", base = None),
        cx_Freeze.Executable("tools/taifex.py", icon="icons/compile.ico", base = None),
